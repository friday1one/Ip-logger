/*
 * -----------------------------------------------------------------------------
 * FILE: netlify/functions/_supabase-client.js
 * PURPOSE: A shared helper file to create a single, reusable Supabase client.
 * This is not a function itself but will be imported by other functions.
 * -----------------------------------------------------------------------------
 */

import { createClient } from '@supabase/supabase-js';

// These environment variables are set in your Netlify site's settings.
